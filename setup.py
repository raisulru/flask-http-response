...
def get_version():
    main_file = os.path.join(CURDIR, "flask_http_response", "main.py")
...
setup(
    ...
    version=get_version(),
    author="Raisul Islam",
    author_email="raisulru10@gmail.com",
    description="",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/raisulru/flask-http-response.git",
    packages=find_packages(exclude=EXCLUDE_FROM_PACKAGES),
    include_package_data=True,
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["flask_http_response=flask_http_response.main:main"]},
    zip_safe=False,
